...
export interface paths {
  "/navigations": {
    get: operations["get/navigations"];
    post: operations["post/navigations"];
  };
  "/navigations/{id}": {
    get: operations["get/navigations/{id}"];
    put: operations["put/navigations/{id}"];
    delete: operations["delete/navigations/{id}"];
  };
  "/wordings": {
    get: operations["get/wordings"];
    post: operations["post/wordings"];
  };
  "/wordings/{id}": {
    get: operations["get/wordings/{id}"];
    put: operations["put/wordings/{id}"];
    delete: operations["delete/wordings/{id}"];
  };
  "/upload": {
...
export interface components {
  schemas: {
    ...
    WordingListResponseDataItem: {
      id?: number;
      attributes?: components["schemas"]["Wording"];
    };
    WordingListResponse: {
      data?: components["schemas"]["WordingListResponseDataItem"][];
      meta?: {
        pagination?: {
          page?: number;
          pageSize?: number;
    ...
    WordingResponseDataObject: {
      id?: number;
      attributes?: components["schemas"]["Wording"];
    };
    WordingResponse: {
      data?: components["schemas"]["WordingResponseDataObject"];
      meta?: Record<string, never>;
    };
    UploadFile: {
      id?: number;
...
export interface operations {
  ...
  "post/wordings": {
    requestBody: {
      content: {
        "application/json": components["schemas"]["WordingRequest"];
      };
    };
    responses: {
      /** @description OK */
